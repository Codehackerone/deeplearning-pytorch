...
# 1. we need to set up numerical maaping to each word to a index
# 2. we need to setup a pytorch dataset to load the data
# 3. Setup padding of every batch (all examples should be of same seq_len and swtup dataloader
...
# Download: python -m spacy download en
...
def main():
    ...
    dataloader = get_loader("flick8k/images", annotation_file="flickr/captions.txt", transform=transform)
