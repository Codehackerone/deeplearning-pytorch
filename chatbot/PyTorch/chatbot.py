...
def train(batch_inputs, batch_targets, lengths_inputs, lengths_targets, encoder, decoder, encoder_optimizer,
...
def trainIters(encoder, decoder, print_every=1000, plot_every=100):
    ...
    for epoch in range(hp.num_epoch):
        ...
        for iter in range(1, int(iter_per_epoch) + 1):
            ...
            loss = train(batch_inputs, batch_targets, lengths_inputs, lengths_targets, encoder, decoder,
            ...
            if iter % print_every == 0:
                ...
                print('%s (%d iters) %.4f' % (
                timeSince(start, total_iterations / float(n_iters)), total_iterations, print_loss_avg))
