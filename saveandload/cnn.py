...
class CNN(nn.Module):
    def __init__(self, in_channels=1, num_classes=10):
        ...
        self.conv1 = nn.Conv2d(in_channels=1, out_channels=8, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)) # same padding
...
def save_checkpoint(state, filename="my_chckpoint.pth,tar"):
...
for epoch in range(num_epochs):
    ...
    if epoch == 2: # best accuracy, anything
